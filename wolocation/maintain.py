...
def setup(x,y,zone):
    ...
    if x >= 0 and x<=250 and y >= 0 and y <= 250 and zone != 2:
    ...
    if x >= 251 and x<=500 and y >= 251 and y <= 500 and zone != 3:
...
def maintain (duty_s):
    ...
    while True:
        ...
        if top.objectDetection == 1:

            zone = setup(top.x,top.y,zone)
